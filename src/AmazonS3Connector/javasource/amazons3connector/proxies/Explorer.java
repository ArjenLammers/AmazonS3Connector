...
public class Explorer
{
	...
	public enum MemberNames
	{
		Bucket("Bucket"),
		Prefix("Prefix"),
		Explorer_Region("AmazonS3Connector.Explorer_Region"),
	...
	/**
	 * @return value of Explorer_Region
	 */
	public final amazons3connector.proxies.Region getExplorer_Region() throws com.mendix.core.CoreException
	{
		return getExplorer_Region(getContext());
	}
	 ...
	 * @return value of Explorer_Region
	 */
	public final amazons3connector.proxies.Region getExplorer_Region(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		amazons3connector.proxies.Region result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Explorer_Region.toString());
		if (identifier != null)
	...
	/**
	 * Set value of Explorer_Region
	 * @param explorer_region
	 */
	public final void setExplorer_Region(amazons3connector.proxies.Region explorer_region)
	{
		setExplorer_Region(getContext(), explorer_region);
	}
	 ...
	 * @param explorer_region
	 */
	public final void setExplorer_Region(com.mendix.systemwideinterfaces.core.IContext context, amazons3connector.proxies.Region explorer_region)
	{
		if (explorer_region == null)
			getMendixObject().setValue(context, MemberNames.Explorer_Region.toString(), null);
		else
			getMendixObject().setValue(context, MemberNames.Explorer_Region.toString(), explorer_region.getMendixObject().getId());
	}
